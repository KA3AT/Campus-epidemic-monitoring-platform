!function (e, t) {
    ...
    t ? t.registerMap ? t.registerMap("china", {
        ...
        features: [{
            ...
            properties: {cp: [121.01 , 23.54], name: "台湾省", childNum: 6}
        }, {
            ...
            }, properties: {cp: [115.21 , 38.44], name: "河北省", childNum: 3}
        }, {
            id: "140000",
            type: "Feature",
            geometry: {
            ...
            }, properties: {cp: [123.42 , 41.29], name: "辽宁省", childNum: 16}
        }, {
            ...
            }, properties: {cp: [126.32 , 43.38], name: "吉林省", childNum: 1}
        }, {
            ...
            }, properties: {cp: [120.15 , 29.28], name: "浙江省", childNum: 45}
        }, {
            id: "340000",
            type: "Feature",
            geometry: {
            ...
            properties: {cp: [117.28 , 31.86], name: "安徽省", childNum: 3}
        }, {
            ...
            properties: {cp: [115.89 , 27.97], name: "江西省", childNum: 1}
        }, {
            ...
            properties: {cp: [113.46 , 34.25], name: "河南省", childNum: 1}
        }, {
            ...
            }, properties: {cp: [113.98 , 22.82], name: "广东省", childNum: 24}
        }, {
            ...
            }, properties: {cp: [108.67 , 23.68], name: "广西壮族自治区", childNum: 2}
        }, {
            id: "460000",
            type: "Feature",
            geometry: {
            ...
            properties: {cp: [110.03 , 19.33], name: "海南省", childNum: 1}
        }, {
            ...
            }, properties: {cp: [103.36 , 30.65], name: "四川省", childNum: 2}
        }, {
            ...
            }, properties: {cp: [106.91 , 26.67], name: "贵州省", childNum: 3}
        }, {
            ...
            }, properties: {cp: [89.13 , 30.66], name: "西藏自治区", childNum: 1}
        }, {
            ...
            }, properties: {cp: [108.94 , 34.46], name: "陕西省", childNum: 1}
        }, {
            ...
            }, properties: {cp: [103.82 , 36.05], name: "甘肃省", childNum: 2}
        }, {
            ...
            properties: {cp: [106.27 , 36.76], name: "宁夏回族自治区", childNum: 2}
        }, {
            ...
            }, properties: {cp: [86.61 , 40.79], name: "新疆维吾尔自治区", childNum: 1}
        }, {
            id: "110000",
            type: "Feature",
            geometry: {
            ...
            properties: {cp: [117.04 , 39.52], name: "天津市", childNum: 1}
        }, {
            id: "310000",
            type: "Feature",
            geometry: {
            ...
            properties: {cp: [121.46 , 31.28], name: "上海市", childNum: 6}
        }, {
            id: "500000",
            type: "Feature",
            geometry: {
            ...
            properties: {cp: [107.51 , 29.63], name: "重庆市", childNum: 2}
        }, {
            id: "810000",
            type: "Feature",
            geometry: {
            ...
            properties: {cp: [114.17 , 22.32], name: "香港特别行政区", childNum: 5}
        }, {
            id: "820000",
            type: "Feature",
            geometry: {type: "Polygon", coordinates: ["@@kÊd°å§s"], encodeOffsets: [[116279, 22639]]},
            properties: {cp: [113.54 , 22.19], name: "澳门特别行政区", childNum: 1}
        }],
        UTF8Encoding: !0
